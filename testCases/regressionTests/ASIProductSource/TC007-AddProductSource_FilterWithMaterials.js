...
describe('AddProductSource-TC07', function () {
    appLogger.Log("************************ Execution Started ***************************");
    appLogger.Log("************************ " + __filename + "***************************");
    beforeEach(function () {
       
        global.current_TestCase = "TC007-AddProductSource_FilterWithMaterials";
      });
    ...
    it('Click on materials filter', function () {          
        createNewJobPage.clickOnMaterials();           
    });
    it('Click on +More link', function () {          
        createNewJobPage.clickOnMoreLink();           
    });
    it('Select one or more materials',function(){
