...
describe('AddProductSource-TC09', function () {
    appLogger.Log("************************ Execution Started ***************************");
    appLogger.Log("************************ " + __filename + "***************************");
    beforeEach(function () {
       
        global.current_TestCase = "TC009-AddProductSource_FilterWithImprintingMethods";
      });
    ...
    it('Click on  Imprinting Methods filter', function () {          
        createNewJobPage.clickOnImprintingMethods();           
    });
    it('Click on +More link', function () {          
        createNewJobPage.clickOnMoreLink();           
    });
    it('Select one or more  Imprinting Methods',function(){
        createNewJobPage.clickOnImprintingMethods()
    })
    it('Click on -Less link', function () {          
        createNewJobPage.clickOnLessLink()        
    });
    it('Remove the selected  Imprinting Methods',function(){
