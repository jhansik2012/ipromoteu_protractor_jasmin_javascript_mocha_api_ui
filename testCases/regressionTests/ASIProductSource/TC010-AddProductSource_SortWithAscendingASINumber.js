...
describe('AddProductSource-TC10', function () {
    appLogger.Log("************************ Execution Started ***************************");
    appLogger.Log("************************ " + __filename + "***************************");
    beforeEach(function () {
       
        global.current_TestCase = "TC010-AddProductSource_SortWithAscendingASINumber";
      });
    ...
    it('Click on Sort dropdown and select Ascending ASI Number item', function () {          
        createNewJobPage.selectSortingOrder('Ascending ASI Number');           
    });
    it('Validate the sort Order', function () {          
        // createNewJobPage.validateProductSort();   
      // functionality is under dev        
    });
