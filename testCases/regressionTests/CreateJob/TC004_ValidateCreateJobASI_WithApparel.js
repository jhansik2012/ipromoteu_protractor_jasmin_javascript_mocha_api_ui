...
describe('CreateJob-TC004', function () {
    appLogger.Log("************************ Execution Started ***************************");
    appLogger.Log("************************ " + __filename + "***************************");
    beforeEach(function () {       
        global.current_TestCase = "TC004-CreateJobASI-WithApparel_ValidateCreateJobWithApparel";
      });
 ...
 it('Navigate iPROMOTEu url', function () {
    ...
    reporter.appendTest('<b>Selecting Products </b>', 'Searching for Produtcs in "Apparels" category- ex: '+apparelKeyword, "");                  
        createNewJobPage.searchProducts(apparelKeyword);           
    });
