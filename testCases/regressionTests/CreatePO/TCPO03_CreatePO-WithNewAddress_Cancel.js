...
describe('CreatePO-TC005', function () {
    appLogger.Log("************************ Execution Started ***************************");
    appLogger.Log("************************ " + __filename + "***************************");
    beforeEach(function () {  
        global.current_TestCase  = "TCPO003-CreatePO-WithNewAddressAndCancel_VerifyWithNewAddressAndCancel";
      });
   ...
   it('Click on down-arrow next to Customer', function () {          
    ...
    it('Select Add New', function () {  
        createPOPage.clickOnAddNewAddress();           
    });

    it('Add New Address', function () {  
        createPOPage.EnterNewDetails("A2Z","SectorA","South","NA","580001","Alaska");           
    }); 

    it('Click on Submit button', function () {          
        createPOPage.clickOnSubmitButton();           
    });
    
    it('Verify Shipping Location', function () {          
        // createPOPage.verifyShippingLocation("Cigniti");           
    });
   ...
   it('Validate subway map ', function () {          
    ...
    it('Click on Cancel button', function () {          
        createPOPage.clickOnCancelButton();           
    }); 
