...
jobStatus='ORDER IN PROCESS'

describe('CreatePO-TC004', function () {
    appLogger.Log("************************ Execution Started ***************************");
    appLogger.Log("************************ " + __filename + "***************************");
    beforeEach(function () {  
        global.current_TestCase  = "TCPO002-CreatePO-WithExistingVendorAndcloseWithoutSending_VerifyWithExistingVendorAndcloseWithoutSending";
      });
...
//
    ...
    it('Verify po created or not', function () {          
        ...
        createPOPage.storeCreatedPoNumberLocal();     // global.poNumber      
