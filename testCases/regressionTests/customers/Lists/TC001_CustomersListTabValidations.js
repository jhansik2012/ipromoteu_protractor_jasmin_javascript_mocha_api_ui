...
describe('Customer header validations : ', function () {
    ...
    beforeEach(function () {
        global.current_TestCase = "TC001-customersListTab_CustomersListTabValidations";
    });
    ...
    it('Click on List Tab', function () {
        customerPage.clickOnListTab();
    });
    it('verify Customers List table is present', function () {
        lineItemDetailsPage.VerifyjobdetailsPageIsdisplayed();
    });
});