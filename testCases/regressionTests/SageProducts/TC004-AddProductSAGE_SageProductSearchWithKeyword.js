...
xdescribe('Add Product', function () {
    ...
    beforeEach(function () {
        ...
        global.current_TestCase = "TC004-SAGEProducts_SageProductSearchWithKeyword";
      });
    ...
    it('Search For Products', function () {          
        createNewJobPage.searchWithKeywordSageProducts(apparelKey);           
    });
    ...
    // it('Validate product colors available', function () {          
    //     createNewJobPage.verifyProductColors(global.productColors,"Product colors");           
    // });

    // it('Validate product sizes available', function () {          
    //     createNewJobPage.verifyProductSizes(global.productSizes);           
    // });
