...
xdescribe('Add Product', function () {
    ...
    beforeEach(function () { 
        global.current_TestCase = "TC010-SAGEProducts_SageProductSearchWithPriceRangeLow"
      });
    ...
    //     createNewJobPage.searchWithCategorySageProducts("tshirt");           
    // });
    it('Search For Products', function () {          
        createNewJobPage.quickSearchSageProducts(quickSeacrhKey);           
    });
