...
xdescribe('Add Product', function () {
    ...
    beforeEach(function () { 
        global.current_TestCase = "TC022-SAGEProducts_SageProductSearchWithSortIntermsOfPopularity"
      });
    ...
    it('Select Sort- Sort the items in terms of popularity, with most popular first', function () {          
