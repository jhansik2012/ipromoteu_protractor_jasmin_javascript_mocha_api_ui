...
describe('Job Screen', function () {
    ...
    beforeEach(function () {
        global.current_TestCase = "TC004-CreateBundledPO-CreateBundledPOByAddingNewAddressThenCancelAndVerify";
    });
...
//Bundled PO Page
    ...
    it('Use other Address', function () { 
       ...
       bundledPOPage.addOtherSavedAddressRadio()
    });
    it('add Shipping Address', function () { 
       bundledPOPage.addDefaultShippingAddress(companyName, address1, address2,city,zip,state) 
    });
