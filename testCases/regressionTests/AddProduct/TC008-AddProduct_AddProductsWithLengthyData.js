...
describe('Add Product', function () {
    ...
    beforeEach(function () {
        ...
        global.current_TestCase = "TC008-AddProduct_AddProductsWithLengthyData";
      });
    ...
    it('Search For Products', function () {          
        createNewJobPage.searchProducts("Shirts123asdfsafdsadkfjsakfhsakjfjhsakjfhksajfhiskakjfhksajfhksajfhksfhkshfksahdfksworeu_lenthyChar");           
    });
    ...
    it('Verify Error message', function () {          
        createNewJobPage.verifyErrorMessage()       
    });
