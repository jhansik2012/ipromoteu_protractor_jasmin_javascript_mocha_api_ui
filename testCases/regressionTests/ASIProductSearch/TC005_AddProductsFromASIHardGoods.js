...
describe('ASIProductSearch-TC05', function () {
    appLogger.Log("************************ Execution Started ***************************");
    appLogger.Log("************************ " + __filename + "***************************");
    beforeEach(function () {
       
        global.current_TestCase = "TC005-ASIProductSearch_AddProductsFromASIHardGoods";
      });
    ...
    it('Search For Products', function () {          
        createNewJobPage.searchProducts("Bottle");           
    });
