...
describe('Customer header validations : ', function () {
    ...
    beforeEach(function () {
        global.current_TestCase = "TC003-NewCustomer-NewCustomerShippingContacts_ValidateNewCustomerShippingContacts";
      });
    ...
    it('Enter Tax Exempt #', function () {          
        customerPage.enterNewCustomerTaxExemptYash("222");           
    });
    ...
    it('Enter Web/Url', function () {          
        customerPage.enterNewCustomerWebURL("www.google.com");          
    });
